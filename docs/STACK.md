...
| impeccable (design skill + detector, dev-time) | Yes | No | No | Apache-2.0; pinned devDependency; deterministic detector CLI runs offline in CI; never in the shipped bundle | manual craft-floor checklist |
